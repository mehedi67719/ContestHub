                ...
                <div className="md:w-1/2 w-full p-6 flex flex-col justify-between space-y-6">
                    <div>
                        ...
                        <div className="overflow-auto max-h-96 p-2 bg-gray-50 rounded-lg mb-3">
                            ...
                            <p className="text-gray-700"><span className="font-semibold">Task:</span> {contest.task}</p>
                        </div>
                    ...
                    {contest.winner && isEnded && (
                        <div className="bg-yellow-50 p-4 rounded-xl shadow flex items-center gap-4 animate-pulse">
                            <img src={contest.winner.photoURL} alt={contest.winner.name} className="w-16 h-16 rounded-full object-cover border-2 border-yellow-400" />
                    ...
                    <div className="flex flex-col md:flex-row gap-4 mt-4">
                        <Link to={`/payment/${contest._id}`}>
                            <Primarybtn className={`w-full md:w-auto ${isEnded ? 'bg-gray-400 cursor-not-allowed' : ''}`}>
